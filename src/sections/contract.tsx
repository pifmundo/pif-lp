      ...
      <Wrapper displaySize={displaySize}>
        <Card>
          <List>
            ...
            <Description>
              O plano básico para o crescimento de uma empresa, um plano enxuto, com os principais benefícios
            </Description>
        ...
        <Card>
          <List>
            ...
            <Description>
            O Plano Premium é uma opção para empresas que precisam de um suporte personalizado e mais recursos para suas campanhas de marketing online.
            </Description>
            <Benefit mark>Lançamento de produto incluso</Benefit>
            <Benefit>
              Suporte prioritário em até 6 horas via whatsapp de um dos nossos conselheiros
            </Benefit>
        ...
        <Card>
          <List>
            ...
            <Description>O Plano Elite é a opção mais completa para empresas que procuram um suporte personalizado e sob medida. Com todos os recursos do Plano Premium, além de design e desenvolvimento personalizados.</Description>
